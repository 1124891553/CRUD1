...
<form action="UpdateUserServlet" method="post">
    <table width="80%" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#CCCCCC">
        ...
        <tr align="center">
            <th>${userone.id }</th>
            <th><input type="text" name="username" value="${userone.username }"></th>
            <th><input type="text" name="password" value="${userone.password }"></th>
            <th><input type="text" name="birthday" value="${userone.birthday }"></th>
            <td><input type="submit" value="修改该用户"></td>
        </tr>
    </table>
</form>
</body>
